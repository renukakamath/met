...
CREATE TABLE `booking` (
  ...
  `no_seats` varchar(100) DEFAULT NULL,
...
insert  into `booking`(`booking_id`,`user_id`,`trip_id`,`rate_id`,`no_seats`,`total`,`date`,`status`) values (2,2,1,4,'2','200','20-05-2022','paid');
...
insert  into `feedback`(`feedback_id`,`user_id`,`feedback`,`date_time`) values (1,2,'bbbb','2022-05-10 22:25:25');
...
insert  into `login`(`login_id`,`username`,`password`,`user_type`) values (1,'admin','admin','admin'),(3,'master','master','master'),(4,'staff','staff','staff'),(5,'user','u','user'),(6,'anu','anu','user'),(7,'amaya','amaya','user');
...
insert  into `message`(`message_id`,`sender_id`,`sender_type`,`receiver_id`,`receiver_type`,`message`,`reply`,`date_time`) values (1,5,'user',3,'master','hloo','hai','2-2-2021'),(2,5,'user',4,'staff','hai','haiii','6-7-2001'),(3,7,'user',4,'staff','hhhhiii','haiii','2022-05-11 21:08:17'),(4,7,'user',7,'master','hloo','pending','2022-05-11 21:11:30');
...
/*Data for the table `occurrence` */

insert  into `occurrence`(`oc_id`,`user_id`,`details`,`status`,`date`) values (1,2,'i dont like','ffff','2022-05-10 22:25:17');
...
insert  into `payment`(`pay_id`,`booking_id`,`amount`,`date`) values (1,2,'200','2022-05-11 21:06:50');
...
insert  into `users`(`user_id`,`login_id`,`first_name`,`last_name`,`email`,`address`,`phone`,`place`) values (1,5,'user','u','u','wert','987654321','werty'),(2,7,'Amaya','philip','qwww@gmail.com','padamittam','9045698745','erkmm');
